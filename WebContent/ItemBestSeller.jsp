...
<div id="wrapper">
        ...
        <div id="page-content-wrapper"  style="text-align: center">
            <div class="container-fluid">
                <div class="row">
<span style="font-size: 14pt; font-family: Arial"><h2><strong>Best Selling Items</strong></h2><br />
        <br />
...
<%
			...
			try 
			{
				...
				//connect to the database
					...
					java.sql.ResultSet rs = stmt1.executeQuery("SELECT * FROM ItemsSold ORDER BY Copies_Sold DESC;");
